...
async def get_feed(
    ...
    try:
        ...
        for post in posts:
            ...
            post_author = await db.users.find_one({"id": post.get("userId")}, {"isVerified": 1})
...
async def get_stories(userId: str, skip: int = 0, limit: int = 50):
    ...
    try:
        ...
        for story in stories:
            # Get story author's verification status
            story_author = await db.users.find_one({"id": story.get("userId")}, {"isVerified": 1})
