...
Frontend (`.env`):
```env
REACT_APP_BACKEND_URL=https://image-fix-social.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
Access the app at: `https://image-fix-social.preview.emergentagent.com`
...
🌐 **Live URL:** https://image-fix-social.preview.emergentagent.com
