...
Frontend (`.env`):
```env
REACT_APP_BACKEND_URL=https://mongodb-to-psql.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
Access the app at: `https://mongodb-to-psql.preview.emergentagent.com`
...
🌐 **Live URL:** https://mongodb-to-psql.preview.emergentagent.com
