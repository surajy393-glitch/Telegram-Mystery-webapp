...
Frontend (`.env`):
```env
REACT_APP_BACKEND_URL=https://api-database-init.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
Access the app at: `https://api-database-init.preview.emergentagent.com`
...
🌐 **Live URL:** https://api-database-init.preview.emergentagent.com
