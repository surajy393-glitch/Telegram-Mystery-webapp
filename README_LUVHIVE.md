...
Frontend (`.env`):
```env
REACT_APP_BACKEND_URL=https://relative-path-fix.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
Access the app at: `https://relative-path-fix.preview.emergentagent.com`
...
🌐 **Live URL:** https://relative-path-fix.preview.emergentagent.com
