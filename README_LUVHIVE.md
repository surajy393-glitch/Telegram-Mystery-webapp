...
Frontend (`.env`):
```env
REACT_APP_BACKEND_URL=https://psql-auth-patch.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
Access the app at: `https://psql-auth-patch.preview.emergentagent.com`
...
🌐 **Live URL:** https://psql-auth-patch.preview.emergentagent.com
