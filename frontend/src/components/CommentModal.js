...
const CommentModal = ({ post, user, isOpen, onClose, onCommentAdded }) => {
  ...
  const fetchComments = async () => {
    try {
      const response = await httpClient.get(`${API}/social/posts/${post.id}/comments?userId=${user.id}`);
  ...
  const handleAddComment = async () => {
    ...
    try {
      ...
      await httpClient.post(`${API}/social/posts/${post.id}/comment`, formData);
  ...
  const handleLikeComment = async (commentId) => {
    try {
      ...
      await httpClient.post(`${API}/social/comments/${commentId}/like`, formData);
      fetchComments();
    } catch (error) {
